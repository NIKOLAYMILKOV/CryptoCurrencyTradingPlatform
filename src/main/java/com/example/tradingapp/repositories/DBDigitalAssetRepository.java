...
@Repository
public class DBDigitalAssetRepository implements DigitalAssetRepository {
    @Autowired
    ...
    public DigitalAsset edit(DigitalAsset asset) {
        ...
        try {
            ...
            statement.setDouble(1, asset.getQuantity());
            statement.setInt(2, asset.getUserId());
            statement.setString(3, asset.getSymbol());
    ...
    public void deleteByUserId(int userId) {
        ...
        try {
            statement = connection.prepareStatement("DELETE FROM digital_assets WHERE user_id=?");
            statement.setInt(1, userId);
